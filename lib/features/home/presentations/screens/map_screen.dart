...
class _MapScreenState extends State<MapScreen> {
  ...
  void _showBinDetail(BinModel bin) {
    showModalBottomSheet(
      ...
      backgroundColor: Colors.transparent,
      builder: (_) =>
          BinDetailSheet(bin: bin, onReportIssue: _navigateToReport),
    );
  }
      ...
      body: Stack(
        children: [
          ...
          Positioned.fill(
            ...
            child: Column(
              children: [
                ...
                Expanded(child: MapPlaceholder(onMarkerTap: _showBinDetail)),
              ],
            ),
          ),
          ...
          Positioned(
            ...
            child: Column(
              children: [
                _FloatingBtn(icon: Icons.my_location, onTap: () {}),
                const SizedBox(height: 12),
                _FloatingBtn(icon: Icons.layers_outlined, onTap: () {}),
                const SizedBox(height: 12),
                _FloatingBtn(icon: Icons.add, onTap: () {}),
              ],
            ),
          ),
